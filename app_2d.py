...
with st.sidebar:
    ...
    with st.expander("⚙️ Training Settings", expanded=False):
        ...
        total_timesteps = st.slider("Timesteps", 10000, 100000, 50000, step=5000)
    ...
    with animation_col:
        ...
        if (results['user_path'] and results['default_path'] and 
            ...
            with st.expander("💡 2D Animation Guide", expanded=False):
                ...
                st.write("**Benefits of 2D View:**")
                st.write("• 📱 Faster rendering")
                st.write("• 🎯 Clearer positioning")
                st.write("• 📊 Better performance tracking")
